package games.negative.engine.paper.loader;
...
public abstract class PaperPluginLoader implements PluginLoader {
    ...
    public void classloader(PluginClasspathBuilder builder) {
        ...
        resolver.addRepository(new RemoteRepository.Builder("negative-games", "default", "https://repo.negative.games/repository/maven-releases/").build());
        resolver.addRepository(new RemoteRepository.Builder("negative-games-snapshots", "default", "https://repo.negative.games/repository/maven-snapshots/").build());
        ...
        resolver.addDependency(dependency("games.negative.moss:moss-paper:1.2.1"));
