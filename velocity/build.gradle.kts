...
dependencies {
    ...
    compileOnly("org.incendo:cloud-velocity:2.0.0-beta.10")

    // Moss
    compileOnly("gg.moonrise.moss:moss-common:1.2.3")
    compileOnly("gg.moonrise.moss:moss-velocity:1.2.3")
    ...
    testImplementation("org.incendo:cloud-velocity:2.0.0-beta.10")
    testImplementation("gg.moonrise.moss:moss-common:1.2.3")
    testImplementation("gg.moonrise.moss:moss-velocity:1.2.3")
    testImplementation("org.springframework:spring-context:6.2.13")
